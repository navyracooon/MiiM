...
class IndexView(TemplateView):
    ...
    def get_recent_memes(self):
        ...
        # tagsはクエリオブジェクトなので注意
        recent_memes = [
                {"image_url": recent_meme_ins.image_url, 
    ...
    def get_trend_memes(self, evaluations):
        ...
        trend_memes = [
                {"image_url": trend_meme_ins.image_url,
    ...
    def get_favorite_memes(self, mi):
        ...
        favorite_memes = [
                {"image_url": favorite_meme_ins.image_url,
    ...
    def get_related_memes(self, mi):
        ...
        related_memes = [
                {"image_url": related_meme_ins.image_url,
